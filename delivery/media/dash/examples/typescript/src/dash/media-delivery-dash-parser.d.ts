...
declare class DashParser {
  ...
  /**
     ...
     * @param mpd json object returned after calling parseMPD and getJSON() methods
     * @param ranges array of strings represnting bandwidths. can be just values or range of values. e.g, ['400000','600000'] or ['400000-700000','100000-1000000']
     ...
     */
  static filterVariantsByBandwidth: (mpd: any, ranges: string[], tolerance?: number) => void;
  /**
     ...
     * @throws {[Error](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)} with appropriate error messages.
     * @example (GenericError: DashParser: failed to filterVariantsByResolution due to DashParser: filterVariantsByResolution ,updateVariantAtIndex and updateVariants need resolution in format 'x-y'.)
     */
  static filterVariantsByResolution: (mpd: any, maxSupportedResolution: string) => void;
  /**
     ...
     * @throws {[Error](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)} with appropriate error messages.
     * @example (GenericError: DashParser: failed to updateVariantAtIndex due to DashParser: filterVariantsByResolution ,updateVariantAtIndex and updateVariants need resolution in format 'x-y'.)
     */
  static updateVariantAtIndex: (mpd: any, resolution: string, newIndex: number) => void;
  /**
     ...
     */
  static updateVariants: (mpd: any, resolutions: string[], newIndex?: number) => void;
  /**
     ...
     * @example (Error: DashParser: failed to filterVariantsByBandwidth due to Cannot read properties of undefined (reading 'forEach')).
     */
  static filterVariantsByAudioLanguage: (mpd: any, languages: string[]) => void;
  /**
     ...
     * @example (Error: DashParser: failed to filterVariantsByBandwidth due to Cannot read properties of undefined (reading 'forEach')).
     */
  static filterVariantsBySubtitlesLanguage: (mpd: any, languages: string[]) => void;
}
