...
* If you have not already installed Postman, visit the [Postman website](https://www.postman.com/) and install the preferred version for your system.
* Choose the following Run in Postman button to open Postman and import the EdgeCompute API Postman collection.
