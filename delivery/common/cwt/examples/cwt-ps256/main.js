...
export const ps256PrivKey1 = `-----BEGIN PRIVATE KEY-----
...
export const ps256PubKey1 = `-----BEGIN PUBLIC KEY-----
...
export async function onClientRequest (request) {
  ...
  try {
    ...
    if (request.path == '/token' && request.method == 'POST') {
      ...
      const cwtToken = await CWTGenerator.sign(claimsSet, signer, { p: CWTUtil.claimsTranslate({ alg: AlgorithmLabels.PS256 }, HeaderLabels)});
