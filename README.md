...
If you have not already installed Postman, visit the [Postman website](https://www.postman.com/) and install the preferred version for your system. Click the "Run in Postman" button import the EdgeCompute API Postman collection into Postman.
